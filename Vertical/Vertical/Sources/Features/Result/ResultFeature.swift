...
struct ResultFeature {
    ...
    struct State: Equatable {
        ...
        init(sessionId: String, readings: [SensorReading], totalClimb: Double) {
            self.sessionId = sessionId
                ...
                VStack(spacing: 20) {
                    ...
                    Button {
                        ...
                        HStack(spacing: 12) {
                            ...
                            Text(store.isPrivacyModeEnabled ? "PRIVACY ON" : "PRIVACY OFF")
                            
                            Text("•")
                                .opacity(0.5)
                            
                            Text(store.isPrivacyModeEnabled ? "START/END HIDDEN" : "FULL PATH VISIBLE")
